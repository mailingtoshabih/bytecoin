    ...
    return (
        <>
            ...
            <div className="px-6 py-4">
                ...
                <div className="font-base text-lg mb-5">Price Change (24 Hour)  {coin.market_data ? ((coin.market_data.price_change_percentage_24h > 0) ? ((<span className="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_24h.toFixed(2)} % </span>)) : (<span className="inline-block bg-red-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_24h.toFixed(2)} % </span>)) : "Data Unavailable"}</div>

                <div className="font-base text-lg mb-5">Price Change (7 Days)  {coin.market_data ? ((coin.market_data.price_change_percentage_7d > 0) ? ((<span className="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_7d.toFixed(2)} % </span>)) : (<span className="inline-block bg-red-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_7d.toFixed(2)} % </span>)) : "Data Unavailable"}</div>

                <div className="font-base text-lg mb-5">Price Change (14 Days)  {coin.market_data ? ((coin.market_data.price_change_percentage_14d > 0) ? ((<span className="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_14d.toFixed(2)} % </span>)) : (<span className="inline-block bg-red-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_14d.toFixed(2)} % </span>)) : "Data Unavailable"}</div>

                <div className="font-base text-lg mb-5">Price Change (30 Days)  {coin.market_data ? ((coin.market_data.price_change_percentage_30d > 0) ? ((<span className="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_30d.toFixed(2)} % </span>)) : (<span className="inline-block bg-red-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_30d.toFixed(2)} % </span>)) : "Data Unavailable"}</div>

                <div className="font-base text-lg mb-5">Price Change (60 Days)  {coin.market_data ? ((coin.market_data.price_change_percentage_60d > 0) ? ((<span className="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_60d.toFixed(2)} % </span>)) : (<span className="inline-block bg-red-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_60d.toFixed(2)} % </span>)) : "Data Unavailable"}</div>

                <div className="font-base text-lg mb-5">Price Change (1 Year)  {coin.market_data ? ((coin.market_data.price_change_percentage_1y > 0) ? ((<span className="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_1y.toFixed(2)} % </span>)) : (<span className="inline-block bg-red-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mb-2 inset-y-0 right-0 ml-5">{coin.market_data.price_change_percentage_1y.toFixed(2)} % </span>)) : "Data Unavailable"}</div>
