            ...
            <footer className="text-center bg-indigo-500 text-white rounded-t-3xl mt-20">
                ...
                <div className="container px-6 pt-6">
                    <div className="flex justify-center mb-6">
                        ...
                        <Link to="https://www.linkedin.com/in/mailingtoshabih" type="button" className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                            <svg aria-hidden="true"
                                focusable="false"
                                data-prefix="fab" 
